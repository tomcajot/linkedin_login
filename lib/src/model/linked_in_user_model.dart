...
class LinkedInUserModel {
  ...
  LinkedInUserModel({
    ...
    this.vanityName,
    this.localizedMaidenName,
  });

//const url = `https://api.linkedin.com/v2/me?projection=(id,localizedLastName,localizedFirstName,localizedHeadline,vanityName,localizedMaidenName,profilePicture(displayImage~:playableStreams))&oauth2_access_token=${token}`
  ...
  factory LinkedInUserModel.fromJson(Map<String, dynamic> json) {
    ...
    final localizedMaidenName = json['localizedMaidenName'];
    ...
    return LinkedInUserModel(
      ...
      localizedMaidenName: localizedMaidenName,
  ...
  final vanityName;
  final String? localizedMaidenName;
  final String? userId;
  ...
  @override
  String toString() {
    return 'LinkedInUserModel{firstName: $firstName, lastName: $lastName, profilePicture: $profilePicture, userId: $userId, localizedFirstName: $localizedFirstName, localizedLastName: $localizedLastName, email: $email, tooooooooken: $token, vanityName: $vanityName, localizedHeadline: $localizedHeadline, localizedMaidenName: $localizedMaidenName';
  }
}
